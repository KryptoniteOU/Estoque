...
#if defined(NDEBUG)
# error "Estoque cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 960;
...
const string strMessageMagic = "Estoque Signed Message:\n";
...
static const int64_t nTargetTimespan = 1 * 60;
